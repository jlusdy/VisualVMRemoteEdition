...
import com.taobao.common.jmx.TaobaoHeapHistogramImpl;
...
public abstract class MemorySamplerSupport extends AbstractSamplerSupport {
    ...
    private final HotSpotHistogramMXBean histogramBean;
    ...
    public MemorySamplerSupport(HotSpotHistogramMXBean histogramBean, MemoryMXBean memoryBean, SnapshotDumper snapshotDumper, HeapDumper heapDumper) {
        this.histogramBean = histogramBean;
            ...
            processor.schedule(new TimerTask() {
                public void run() {
                    try {
                        ...
                        HeapHistogram h = new TaobaoHeapHistogramImpl(histogramBean.getHistogramText());
                        doRefreshImplImpl(h, views);
                    } catch (Exception e) {
                        terminate();
                    }
                }
